...
export const routes = [
  ...
  { path: `${process.env.PUBLIC_URL}/Teamtable/:layout`, Component: <Teamtable /> },
  { path: `${process.env.PUBLIC_URL}/Userreferral/:layout`, Component: <Userreferral /> },
  { path: `${process.env.PUBLIC_URL}/user/:userId/layout`, Component: <UserDetails /> },
