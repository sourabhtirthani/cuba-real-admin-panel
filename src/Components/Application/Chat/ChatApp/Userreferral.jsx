...
const Userreferral = () => {
    ...
    const [data, setData] = useState(
        [
            {
                sno: '1', name: 'Tiger Nixon', id: '	#101', SponserName: 'Admin', Level: '1 Level', MobileNo: '+91XXXXX', EmailID: 'Admin@gmail.com', SponserID: '61', UserWalletAddress: '	$320,800', SponserWalletAddress: 'male', time: '21:37', wallet: '$2125', joindate: '2023/02/12', Date: '2023/04/12',
                ReferralIncome: '$12', LevelIncome: '$22', PackageIncome: '$25', SlotIncome: '$20,', TotalIncome: '$5',
                Action: (<>   <PersonIcon titleAccess='User' className='SinglePerson' />  <GroupIcon titleAccess='Team' className='team' />  </>)
            },
            {
                sno: '1', name: 'Tiger Nixon', id: '	#101', SponserName: 'Admin', Level: '1 Level', MobileNo: '+91XXXXX', EmailID: 'Admin@gmail.com', SponserID: '61', UserWalletAddress: '	$320,800', SponserWalletAddress: 'male', time: '21:37', wallet: '$2125', joindate: '2023/02/12', Date: '2023/04/12',
                ReferralIncome: '$12', LevelIncome: '$22', PackageIncome: '$25', SlotIncome: '$20,', TotalIncome: '$5',
    ...
    return (
        <Fragment>
            <Breadcrumbs mainTitle='User Refrral' parent='User Refrral' title='User Refrral' />
                        ...
                        <div className='card'>
                            <div className='card-body'>
                                <div className='card-title' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <h4 className='mb-0'>User Refrral Table</h4>
